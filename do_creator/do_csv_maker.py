...
if __name__ == "__main__":
	...
	for uri in latest_series:
		...
		record_dict['file_version_1_caption'] = ""
		record_dict['file_version_2_uri'] = ""
		record_dict['file_version_2_caption'] = ""
	...
	with open('digital_object_template.csv', mode='w') as template:
		fieldnames = ['resource', 'title', 'begin', 'uri', 'hierarchy', 'level', 'digital_object_title', 'digital_object_id', 'publish', 'file_version_1_uri', 'file_version_1_caption', 'file_version_2_uri', 'file_version_2_caption']
